// tar -zxvf
// wx6e015d421ed12a53
// 31310bd46706f26565d3041994c25f77
...
JSSDK.prototype={
    ...
    if (typeof data.expireTime === 'undefined' || data.expireTime < time) {
        const url = `https://qyapi.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=${this.appId}&secret=${this.appSecret}`;
        request.get(url, function (err, res, body) {
            if (err) {
                return done(err, null);
            }
...
const jssdk=new JSSDK('wx6e015d421ed12a53','31310bd46706f26565d3041994c25f77')
